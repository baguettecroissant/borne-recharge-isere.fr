...
async function fetchCities() {
  ...
  console.log('Fetching Isère (38) communes from Geo API...');
  try {
    ...
    // Process and filter communes in Isère (38) with population >= 2000
    const processed = data
      .map(c => {
        let lat = 45.188529; // Grenoble lat
        let lng = 5.724524;  // Grenoble lng
